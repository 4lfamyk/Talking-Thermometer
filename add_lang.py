...
# -v verbosity
cmd='curl '+ \
    '--output ./lang/support/'+sys.argv[2]+'.mp3 '+ \
    "\""+'https://code.responsivevoice.org/develop/getvoice.php?t='+msg+'&tl='+sys.argv[2]+'-US&sv=g2&vn=&pitch=0.5&rate=0.5&vol=1'+"\""+ \
...
print('***************************')
run(cmd)
os.system("mpg123 -w ./lang/support/"+sys.argv[2]+".wav ./lang/support/"+sys.argv[2]+".mp3")
os.system("rm ./lang/support/*.mp3")
os.system("get_lang_v2.py "+sys.argv[1]+ " 0.0 " + sys.argv[3] + " 0.5 ")
